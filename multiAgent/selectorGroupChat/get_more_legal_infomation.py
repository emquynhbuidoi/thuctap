...
def get_more_legal_information(current_information: str, dieu_from_vsearch:str, khoan_from_vsearch:str, kg: Neo4jGraph):
        current_information_edit = current_information
        ...
        if "điều này" not in current_information and "khoản này" not in current_information and 'luật này' not in current_information:     #Nếu trong Điều, Khoản trả lời không có tham chiếu return về trực tiếp ko cần chạy thêm query cypher khác
        ...
        if 'luật này' in current_information:
