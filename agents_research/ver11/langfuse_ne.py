...
class LangfuseHandler:
    def __init__(self):
        ...
        self.newSession_id = ''                                         # Lưu session id tại mới. Nếu đang chat với phiên mới                          
    ...
    def update_current_trace(self, name, session_id, input, output):
        if "Dựa vào file trả lời câu hỏi:" in input:
            input = input.split("Dựa vào file trả lời câu hỏi:")[1]
